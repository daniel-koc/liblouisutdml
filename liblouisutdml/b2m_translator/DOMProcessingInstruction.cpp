// DOMProcessingInstruction.cpp: implementation of the CDOMProcessingInstruction class.
//
//////////////////////////////////////////////////////////////////////
...
CDOMProcessingInstruction::CDOMProcessingInstruction(CDOMDocument* pOwnerDocument)
...
{
CDOMProcessingInstruction* pNewProcessingInstruction = m_pOwnerDocument->CreateProcessingInstruction(new CString(*m_pStrTarget), new CString(*m_pStrData));
